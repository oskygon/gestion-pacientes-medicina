  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        duration: 0.5
          ...
          <p className="text-gray-600 dark:text-blue-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div className="space-y-4">
              <div className="flex items-center">
                <Search className="w-6 h-6 text-medical-600 dark:text-gray-400 mr-3" />
              ...
              <SearchInput onSearch={handleSearch} placeholder="Nombre, apellido o número de HC..." className="mt-2" />
            </div>
            
            <div className="space-y-4 bg-medical-50 dark:bg-gray-700/50 rounded-xl p-5 cursor-pointer hover:bg-medical-100 dark:hover:bg-gray-700 transition-colors duration-300" onClick={handleNewPatient}>
              <div className="flex items-center">
                <PlusCircle className="w-6 h-6 text-medical-600 dark:text-gray-400 mr-3" />
              ...
              <button className="btn-medical mt-2 w-full text-red-800">
        ...
        {isSearching && <motion.div variants={containerVariants} initial="hidden" animate="visible" className="mt-8">
            ...
            {searchResults.length === 0 ? <motion.div variants={itemVariants} className="text-center py-12">
                ...
                {searchResults.map(patient => <motion.div key={patient.id} variants={itemVariants}>
                    <PatientCard patient={patient} onClick={() => patient.id && handlePatientClick(patient.id)} />
                  </motion.div>)}
              </div>}
          </motion.div>}
      </div>
